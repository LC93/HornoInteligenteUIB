...
#define MAXTASK 11 // Maximum tasks --> NOTE: up to 254 (if enough memory)
#define MAXSEM 7  // Maximum semaphore --> NOTE: up to 255 (if enough memory)s
#define MAXMB 5	 // Maximum mailboxe --> NOTE: up to 255 (if enough memory)s
#define MAXFLAGS 6 // Maximum flag --> NOTE: up to 255 (if enough memory)s
